...
.lkb-kLegend .srRes{color:#e03131;font-weight:600}
.lkb-kLegend .srSup{color:#0f9d6e;font-weight:600}
...
`;
		...
		// 压力位/支撑位:基于截至 hover 日的最近 60 根K线检测摆动高低点(左右各2根确认),不使用未来数据
		...
		function KlineChart({ klines }) {
			...
			return h(
				...
				h(
					...
					h("span", { className: "srRes" }, "压力位 ", fmt(sr.res)),
					h("span", { className: "srSup" }, "支撑位 ", fmt(sr.sup))
				),
				h(
					"div",
					...
					h(
						...
						h("line", { x1: 0, x2: W, y1: py(sr.res), y2: py(sr.res), stroke: UP_COLOR, strokeDasharray: "3 3", strokeWidth: 0.7, vectorEffect: "non-scaling-stroke", opacity: 0.5 }),
						h("line", { x1: 0, x2: W, y1: py(sr.sup), y2: py(sr.sup), stroke: DOWN_COLOR, strokeDasharray: "3 3", strokeWidth: 0.7, vectorEffect: "non-scaling-stroke", opacity: 0.5 }),
						h("line", {
							x1: 0,
							x2: W,
